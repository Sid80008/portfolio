    ...
    >
      <div className="h-56 sm:h-72 w-full bg-[#0a0a0a] relative overflow-hidden border-b border-white/5">
        ...
        <div className="absolute top-4 right-4 flex gap-2">
           <a href={project.link} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background/50 backdrop-blur-md rounded-full hover:bg-white hover:text-black transition-colors">
